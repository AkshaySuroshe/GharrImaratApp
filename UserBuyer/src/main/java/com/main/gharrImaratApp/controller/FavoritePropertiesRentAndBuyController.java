...
//	}
	...
	@GetMapping("/properties/buyer/rb/{userBuyer1ID}/{userBuyer2ID}")
	...
	@DeleteMapping("properties/buyer/rb/del/{propertyRBID}")
	public ResponseEntity<FavoritePropertiesRentAndBuy> deletePropertyRB(@PathVariable UUID propertyRBID)
	{
	FavoritePropertiesRentAndBuy propRB=	favoritePropertiesRentAndBuyService.deleteProperty(propertyRBID);
